                    ...
                    <form role="form" action="{{url('/admin/category/update')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="icon">Product Icon (243 X 222px)</label>
                                        <input type="hidden" id="icon" name="old_icon" value="{{$editable_value['icon']}}">
                                        @if(!empty($editable_value['icon']))
                                            <img src="{{asset($editable_value['icon'])}}" id="icon" name="icon" alt="" width="100px">
                                        @endif
